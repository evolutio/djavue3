...
- [backend] MELHORIA #5 Utiliza [dj-database-url](https://pypi.org/project/dj-database-url/) para gerar url de conexão com DB. Thanks @Walisson Buser
- [backend] MELHORIA #10 Adiciona django-extensions
- [backend] MELHORIA #2 Utiliza AbstractUser ao invés de um Profile. Thanks @Walisson Buser
- [frontend] DOCS Adiciona README.md em cada pasta do frontend para melhor entendimento
